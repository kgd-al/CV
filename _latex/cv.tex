...
%    \addlinespace[.1cm]
 ...
 \itm{Synopsis}{}{
  ...
  \Fr{Suite \`a un doctorat centr\'e sur des plantes artificielles et leurs dynamiques \`a l'\'echelle \'evolutionaire, je projete de revenir \`a mon int\'er\^et principal: la cognition artificielle.
  Plus pr\'ecis\'ement, mes objectifs sont d'\'etudier les m\'ecanismes par lesquels des formes d'interaction haut-niveau peuvent \^etre construites \`a travers des entr\'ees/sorties bas niveau, particuli\`erement en r\'eponse \`a des contraintes environnementales.}
 }%
 \\
...
\begin{sect}{\En{Education}\Fr{\'Education}}
 \itm{PhD}{2016 - \En{July} 2020}{%
  ...
  {\small%
    ...
    \Fr{\'Etude sur la mani\`ere dont la complexification de cr\'eatures artificielles pourrait \^etre am\'elior\'ee par la d\'eplacement des controlleurs autour du composant abiotique d'un \'ecosyst\`eme}
  } \\
 ...
 \itm{Master}{2014 - 2016}{
  ...
  {\small%
    ...
    \Fr{Intelligence artificielle: mod\`eles math\'ematiques et symboliques, m\'ethodes d'entrainement}
  }
 }
 \\
...
\begin{sect}{\En{Experience}\Fr{Exp\'erience}}
 ...
 \itm{\En{Teachings}\Fr{Enseignements}}{2016 - 2017}{%
  ...
  \di L2 \En{project monitoring on C programming}%
         \Fr{Encadrement de projet de programmation en C}%
  \\
 }
 \\
 ...
 \itm{\internship}{2016 (6 \months)}{%
  ...
  {\small%
    ...
    \Fr{D\'eploiment de g\'enomes \`a base de r\`egles sur la plateforme MecaCell pour \'etudier la croissance de plantes et la sp\'ecialisation cellulaire.}%
  }%
 }
 \\
 ...
 \itm{\internship}{2015 (3 \months)}{
  ...
  {\small%
    ...
    \Fr{\'Etude sur les differences de performance entre R\'eseaux de Neurones Artificiels et R\'eseaux de R\'egulation G\'en\'etiques sur des donn\'ees de pr\'ediction de temp\'erature.}%
  } \\
 ...
 \itm{\internship}{2014 (2 \months)}{
  ...
  {\small%
    ...
    \Fr{Application de Mod\`eles de Markov Cach\'es au challenge BirdClef2014 pour l'identification d'esp\`eces d'oiseaux dans un corpsus de plusieurs milliers d'enregistrements.}%
  } \\
...
\begin{sect}{\En{Scholarships and Fellowships}%
 ...
 \itm{2016}{70K \euro}
     {\En{PhD Fellowship from the French Minister of Higher Education and Research (MESR) - over 3 years}%
      \Fr{Bourse doctoral du Minist\`ere de l'enseignement sup\'erieur - sur 3 ans}}
 \\
