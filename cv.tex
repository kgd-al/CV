...
\begin{tikzpicture}[remember picture, overlay]
 ...
 \def\angle{0}
 \foreach \n/\a in {\aPI/144, \aEd/-92, \aPE/-63, \aPC/-75, \aCS/-55, \aMi/-55} { \pgfmathsetmacro{\angle}{\angle+\a} \xdef\angle{\angle} \expandafter\xdef\n{\angle} }
 
 \node [rotate=\aPI-82.5] (C) at (page.center) {\includegraphics[width=\D]{phylogenetics}};
 ...
 \draw [shift={(page.center)}, ultra thin]
   (0,0) -- (\aPI:\R) -- (PI)
%      (\aPI:.3*\R) arc (\aPI:\aMi:.3*\R) -- (\aMi:\R) -- (Mi)
%      (\aPI:.45*\R) arc (\aPI:\aEd:.45*\R) -- (\aEd:\R) -- (Ed)
%        (\aEd:.6*\R) arc (\aEd:\aPE:.6*\R) -- (\aPE:\R) -- (PE)
%          (\aPE:.75*\R) arc (\aPE:\aCS:.75*\R) -- (\aCS:\R) -- (CS)
%          (\aPE:.9*\R) arc (\aPE:\aPC:.9*\R) -- (\aPC:\R) -- (PC)
       ;
       
  \def\d{.05}
  \draw [red,shift={(page.center)}] (\aPI:.175*\R) circle (\d) circle (\d pt);
