...
\newcommand{\docite}[1]{\fullcite{#1}}

\def\mailto#1{\small(\href{mailto:#1}{\texttt{#1}})}

\def\me{K\'evin Godin-Dubois}
\makeatletter
\hypersetup{
 pdfinfo={
  Author={\me},
...
\begin{tikzpicture}[remember picture, overlay]
 ...
 \nsect[anchor=south west, at={(page.south west)}]{PC}{Publications and Conferences}{
  \\
  \di \docite{GodinDubois2020a} \\
  \di \docite{GodinDubois2019c} \\
  \di \docite{GodinDubois2019b} \\
  \hangindent=2em
  \di \docite{GodinDubois2019a} \\
  \di Poster presentation \docite{GodinDubois2018} \\
%   \hangindent=1em
  \di \docite{Dubois2017} \\
 }{\textwidth}
