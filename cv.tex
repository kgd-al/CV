...
\newcommand{\skilldisk}[1]{
 ...
 \begin{tikzpicture}
  ...
  \shade[ball color = \sbcolor!40, opacity = 0.8] (0,\R) arc (90:\A:\R) -- (0,0) -- cycle;
 \end{tikzpicture}
}
...
\begin{tikzpicture}[remember picture, overlay]
 ...
 \def\angle{0}
 \foreach \n/\a in {\aPI/142, \aEd/-92, \aPE/-63, \aPC/-75, \aCS/-55, \aMi/-55} { \pgfmathsetmacro{\angle}{\angle+\a} \xdef\angle{\angle} \expandafter\xdef\n{\angle} }
 
 \node [rotate=\aPI-80] (C) at (page.center) {\includegraphics[width=\R]{phylogenetics}};
   ...
   (0,0) -- (\aPI:\R) -- (PI)
     ...
     (\aPI:.6*\R) arc (\aPI:\aEd:.6*\R) -- (\aEd:\R) -- (Ed)
       (\aEd:.7*\R) arc (\aEd:\aPE:.7*\R) -- (\aPE:\R) -- (PE)
         (\aPE:.8*\R) arc (\aPE:\aCS:.8*\R) -- (\aCS:\R) -- (CS)
         (\aPE:.9*\R) arc (\aPE:\aPC:.9*\R) -- (\aPC:\R) -- (PC)
       ;
