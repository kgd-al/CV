...
\begin{tikzpicture}[remember picture, overlay]
 ...
 \nsect[anchor=west,at={(page.172.5)}]{Mi}{Miscellaneous}{
  ...
  \\\textbf{Hobbies} \\
  Tabletop RPG \\
  Reading (Carlton Mellick III, Warhammer 40K) \\
...
%        ;
  ...
  \foreach \a/\n/\r in {\aPI/PI/.15, \aEd/Ed/.855, \aPE/PE/.73, \aPC/PC/.605, \aCS/CS/.545, \aMi/Mi/.3} {
   \draw [shift={(page.center)}, gray, line width=.25pt] (\a:\r * \R) -- (\a:\R) -- (\n);
%    \draw [shift={(page.center)}, green, dotted] (\a:\r * \R) -- (\a:1.5*\R);
  }
